...
--  ===============================================================================================
    ...
    return {
        ...
        { "nvim-mini/mini.notify", version = "*", config = function() require('mini.notify').setup({}) end },
        ...
        { "nvim-mini/mini.trailspace", version = "*", config = function() require('mini.trailspace').setup({}) end },
    }
